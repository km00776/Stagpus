...
class _EventFormState extends State<EventForm>
  ...
  createEventInFirestore(
    ...
    eventLocationCollectionRef.document(eventId).collection('locationOfEvent').document(eventLocationId).setData({
      "longtitude" : eventLongtitude,
  ...
  body: ListView(
      children: <Widget>[
        Text("Dear SuperUser, enter longtitude and latitude so we can add event to maps"),
        Padding(
